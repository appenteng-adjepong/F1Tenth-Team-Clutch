...
class VehicleCommandNode(Node):
    ...
    def __init__(self): #Creat a constructor
        ...
        self.steering_command_publisher = self.create_publisher(Float32, '/autodrive_clutch/steering_command', qos_profile)
        self.throttle_command_publisher = self.create_publisher(Float32, '/autodrive_clutch/throttle_command', qos_profile)
